...
export const darkEditorColours: EditorColours = {
  ...
  sidebarTop: '#f4f9fd',
  sidebar: '#f2f2f2',
  sidebarBottom: '#E1E2E6',
  sidebarItemActive: '#444',
  sidebarItemSide: '#2D354C',
  sidebarItemSessions: 'rgba(255, 255, 255, 0.05)',
  tab: '#97A6C0',
  tabInactive: '#22292F',
  tabText: '#050D29',
  navigationBar: '#f4f9fd',
  navigationBarText: '#050D29',
  editorBackground: '#f7f7f7',
  resultBackground: '#f2f2f2',
  leftDrawerBackground: '#E1E2E6',
  rightDrawerBackground: '#E1E2E6',
  drawerText: '#d64292',
